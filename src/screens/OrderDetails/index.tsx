      ...
      <div className="h-screen">
        <Sidebar className="block">
          ...
          <LoadingErrorPlaceholder isLoading={isLoading} isError={isError}>
            ...
            <h1 className="text-2xl font-bold mt-8 mb-4">المنتجات المطلوبة</h1>
            {orderDetails.order?.notes && (
              <p className="mb-8">ملاحظات: {orderDetails.order?.notes}</p>
            )}
                  ...
                  productChildren={
                    <>
                      <div className="flex items-center gap-5">
                        <div>
                          السعر:{" "}
                          <Badge className="mt-4" color="primary">
                            {product?.product?.price}
                          </Badge>
                        </div>
                        <div>
                          العدد:{" "}
                          <Badge className="mt-4 px-2" variant="outline">
                            {product?.quantity}
                          </Badge>
                        </div>
                      </div>
